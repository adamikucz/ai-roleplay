...
export function chooseModel(input: { preference?: string; emotionalIntensity:number; contextChars:number; lastModel?: string | null }): ModelRoute {
  ...
  return { primary, fallback:['meta-llama/llama-3.3-70b-instruct:free', 'qwen/qwen3-next-80b-a3b-instruct:free'], temperature:.85, maxTokens:1500, reason:'user_preference' };
}
